...
public class Crypto implements Serializable {
    ...
    public Crypto(String Name, String asset_id,  String data_start, String data_end,
                  ...
                  int data_symbols_count, double volume_1hrs_usd, double volume_1day_usd, double volume_1mth_usd,int type_is_crypto, double price_usd, String id_icon) {
    ...
    public boolean equals(Object o) {
        ...
        return getType_is_crypto() == crypto.getType_is_crypto() &&
                getAsset_id().equals(crypto.getAsset_id()) &&
                getName().equals(crypto.getName());
    }

    @Override
    public int hashCode() {
        return Objects.hash(getAsset_id(), getName(), getType_is_crypto());
    }
